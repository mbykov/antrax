...
modCorr['act.pres.ind'] = ['act.pres.ind', 'act.pres.opt', 'act.pres.sub', 'act.pres.imp', 'mp.pres.ind', 'mp.pres.opt', 'mp.pres.sub', 'mp.pres.imp', 'act.impf.ind', 'mp.impf.ind', 'mp.impf.ind', 'act.pres.inf', 'mid.pres.inf', 'pass.aor.sub', 'pass.aor.opt']
...
modCorr['act.aor.ind'] = ['act.aor.ind', 'mp.aor.ind', 'act.aor.opt', 'act.aor.sub', 'act.aor.imp', 'mp.aor.imp', 'pass.aor.opt', 'pass.aor.sub', 'fp.aor.ind', 'pass.aor.imp', 'pass.aor.inf', 'pass.fut.inf']

modCorr['pass.aor.ind'] = ['pass.aor.ind', '']

utils.prototype.modCorr = modCorr

let augmods = ['act.impf.ind', 'mp.impf.ind', 'mp.impf.ind', 'act.aor.ind', 'mp.aor.ind', 'act.ppf.ind', 'mp.ppf.ind', 'pass.aor.ind']
